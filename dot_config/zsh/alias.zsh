...
alias snowflake='snowflake_id=$(~/.local/scripts/snowflake/snowflake.py);echo $snowflake_id; echo $snowflake_id | pbcopy'
alias update="sudo -H darwin-rebuild switch --flake ."
