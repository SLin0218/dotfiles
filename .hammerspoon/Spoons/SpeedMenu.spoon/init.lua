...
local function data_diff()
    ...
    local c = hs.canvas.new{ x= 0, y = 0, h = 0, w = 0 }
    ...
    -- bigSur multi-line textual fix use canvas  https://github.com/Hammerspoon/hammerspoon/issues/2741
    c:frame(c:minimumTextSize(obj.disp_str))
    c[1] = { type = "text", text = obj.disp_str }
    obj.menubar:setIcon(c:imageFromCanvas())
